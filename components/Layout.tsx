    ...
    <div className="flex flex-col h-screen overflow-hidden bg-white dark:bg-black text-slate-900 dark:text-slate-50 transition-colors duration-300 relative selection:bg-slate-200 dark:selection:bg-slate-800 font-sans">
      ...
      <header className="flex-none h-16 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-black/80 backdrop-blur-md flex items-center justify-between px-6 z-50 transition-colors duration-300">
        <div className="flex items-center gap-3">
          ...
          <span className="font-black tracking-tighter text-xl text-slate-900 dark:text-white uppercase">Panel AI</span>
        </div>
        
        <div className="flex items-center gap-4">
          <button 
            onClick={onShowGuide}
            className="flex items-center gap-2 px-4 py-2 rounded-full border border-slate-300 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-900 transition-all text-[10px] font-black uppercase tracking-widest text-slate-700 dark:text-slate-300 focus:outline-none shadow-sm active:scale-95"
          >
      ...
      {/* Global Footer */}
      <footer className="flex-none py-10 border-t border-slate-100 dark:border-slate-900 bg-white/80 dark:bg-black/80 backdrop-blur-md flex flex-col items-center justify-center z-50 transition-colors duration-300 gap-4">
        <div className="text-xs font-medium text-slate-500 dark:text-slate-400">
          Developed by <a href="https://liowshanyi.site" target="_blank" rel="noopener noreferrer" className="text-slate-900 dark:text-white hover:underline decoration-slate-300 dark:decoration-slate-700 transition-all font-bold underline-offset-4">Shanyi Liow</a>
        </div>
        <div className="flex items-center gap-6">
           <a href="https://github.com/syliow" target="_blank" rel="noopener noreferrer" title="GitHub" className="text-slate-400 hover:text-black dark:hover:text-white transition-all transform hover:scale-110">
           ...
           <a href="https://linkedin.com/in/syliow" target="_blank" rel="noopener noreferrer" title="LinkedIn" className="text-slate-400 hover:text-[#0077b5] transition-all transform hover:scale-110">
