      ...
      <div className="max-w-3xl mx-auto flex items-center justify-between">
        ...
        <div className="w-1/3 flex items-center justify-center gap-8">
          ...
          <button
            ...
            className={`group relative flex items-center justify-center h-14 w-14 rounded-full border transition-all duration-300 ${
              isMuted 
                ? 'border-red-500 text-red-500 bg-red-50 dark:bg-red-900/10' 
                : 'border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white hover:border-black dark:hover:border-white'
            }`}
          >
          ...
          <button
            onClick={onEndCall}
            className="flex items-center justify-center h-14 w-14 rounded-full bg-red-600 hover:bg-red-700 text-white transition-colors duration-300"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
