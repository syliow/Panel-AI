...
import { ConnectingAudioVisualizer } from './ConnectingAudioVisualizer';
...
export const InterviewScreen: React.FC<InterviewScreenProps> = ({ config, onEndSession }) => {
  ...
  const handleEndClick = React.useCallback(() => setIsEnding(true), [setIsEnding]);
            ...
            {hasStarted && status === 'connected' && transcript.length === 0 && !isAiSpeaking && (
                <div className="flex-1 flex flex-col items-center justify-center p-8">
                   <div className="text-center space-y-6 max-w-md">
                      ...
                      <ConnectingAudioVisualizer subscribeToVolume={subscribeToVolume} />
